...
<head>
    ...
    <meta name='description' content="Профессиональная полировка вставок салона автомобиля в Екатеринбурге. Обработка керамическим покрытием и жидким стеклом. Удаление царапин и сколов. Керамика для авто и мотоциклов. Покрытие керамикой дисков, стекол и пластика.">
    <title>Полировка вставок в салоне - Детейлинг-центр «AlfaCar»</title>
        ...
        <div class="container">
            <div id="services_page_services">
                ...
                <div class="advantages">
                    <div class="h2box">
                        <h2>
                            Полировка вставок в салоне
                        </h2>
                    </div>

                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <img src="<?php echo $home;?>img\services\page\polirovka_vstavok\1.jpg" alt=""
                                class="unselectable">
                            <div class="btnbox">
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <h5>
                                Этапы полировки вставок:
                            </h5>
                            <p>
                                <img src="<?php echo $home;?>img/tick.svg" alt="">
                                Тщательная <b>детейлинг-мойка</b> вставки
                            </p>
                            <p>
                                <img src="<?php echo $home;?>img/tick.svg" alt="">
