...
<head>
    ...
    <meta name="description" content="Выправление вмятин без покраски по немецкой технологии PDR. Полное и частичное удаление вмятин, неровностей, вдавышей. Локальное удаление вмятин после града.">
    <title>Выправление вмятин - Детейлинг-центр «AlfaCar»</title>
                ...
                <div class="using">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <h5>Выправление вмятин без покраски</h5>

                            <img src="<?php echo $home;?>img/services/page/vypravlenie_vmyatin/1.jpg" alt="">


                        </div>
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <h5>
                                Благодаря немецкой технологии PDR мы сможем устранить вмятины:
                            </h5>
                            <p>
                            ...
                            <p>
                                <img src="<?php echo $home;?>img/tick.svg" alt="">
                                От воздействий рукоприкладства
                            </p>
                            <p>
                                <img src="<?php echo $home;?>img/tick.svg" alt="">
                                От воздействий различных предметов (ветки, деревья, столбы)
                            </p>
                            
                            <button class='btn maxbtn'><l>от 1 990</l> <br>от 990 руб.</button>
